              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                <div className="space-y-6">
                  ...
                  <motion.div
                    ...
                    className="bg-blue-50/50 dark:bg-blue-950/20 p-5 md:p-6 rounded-xl border border-blue-200/50 dark:border-blue-400/20"
                  >
                ...
                >
                  ...
                  >
                    <Button
                      type="submit"
                      disabled={isLoading}
                      className="w-full bg-blue-600 hover:bg-blue-700 text-white h-11 md:h-12 px-6 md:px-8 shadow-lg shadow-blue-500/30 dark:shadow-blue-500/20"
                    >
                      {isLoading ? (
