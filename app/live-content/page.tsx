...
export default function LiveContentPage() {
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      {/* Header Section */}
      <div className="mb-8">
        <h1 className="text-4xl font-bold mb-2">Live Content Feed</h1>
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-blue-700 dark:text-blue-300 mt-1">
              This page uses Firebase Firestore's real-time listeners to display
              content. Add, update, or delete documents in the{" "}
              <code className="px-1 py-0.5 bg-blue-100 dark:bg-blue-900/40 rounded">
                refresh_data
              </code>{" "}
              collection to see instant updates here without refreshing!
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="bg-muted/30 rounded-lg p-4">
            ...
            <ol className="list-decimal list-inside space-y-1 ml-2">
              ...
              <li>
                ...
                <code className="px-1 py-0.5 bg-muted rounded">title</code>{" "}
                (string) and{" "}
                <code className="px-1 py-0.5 bg-muted rounded">message</code>{" "}
                (string)
              </li>
...
await addDoc(collection(db, 'refresh_data'), {
  ...
  timestamp: serverTimestamp()
          ...
          <div className="bg-muted/30 rounded-lg p-4">
            <h3 className="font-semibold text-foreground mb-2">
              Option 3: Quick Test (Use API Routes)
            </h3>
            <p className="mb-2">
              Use the API routes to add test content directly:
            </p>
