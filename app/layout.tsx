    ...
    <ClerkProvider
      appearance={{
        ...
        elements: {
          ...
          formFieldLabel:
            "text-gray-700 dark:text-gray-300 font-medium mb-3 text-sm uppercase tracking-wide",
          ...
          otpCodeFieldInput:
            "border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent",
