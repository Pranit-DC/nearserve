...
import { FiCalendar, FiMapPin, FiFileText, FiCheck } from "react-icons/fi";
      ...
      {open &&
        ...
        createPortal(
          <>
            ...
            <div
              className="fixed inset-0 z-[101] flex items-center justify-center p-4 pointer-events-none animate-in fade-in zoom-in-95 duration-200"
              style={{
                position: "fixed",
                top: 0,
                left: 0,
                        ...
                        <div className="space-y-4 sm:space-y-6">
                          <div>
                            ...
                            <p className="text-xs text-gray-500 dark:text-gray-400 mt-2">
                              Type naturally (e.g., &ldquo;tomorrow at
                              2pm&rdquo;) or use the calendar picker
                            </p>
                          </div>
                          ...
                          <div className="mt-4 sm:mt-6 md:mt-8 p-4 sm:p-6 bg-gray-50 dark:bg-[#171717] border border-gray-200 dark:border-gray-800 rounded-lg">
                            ...
                            <div className="space-y-2 sm:space-y-3 text-xs sm:text-sm">
                              ...
                              <div className="flex justify-between pt-2 sm:pt-3 border-t border-gray-300 dark:border-gray-700">
                                ...
                                <span className="font-bold text-blue-600 dark:text-blue-400 text-base sm:text-lg">
                                  ₹{booking.charge || "0"}
                                </span>
                              </div>
                            </div>
